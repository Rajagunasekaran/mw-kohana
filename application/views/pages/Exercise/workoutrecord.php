...
?>
	<li data-orderval="<?php echo $order;?>" data-role="none" class="bgC4" data-inner-cnt="<?php echo (isset($exerciseRecord['setdetails'][$keys]) ? count($exerciseRecord['setdetails'][$keys]) : 0);?>" data-id='<?php echo $data_id;?>' data-title='<?php echo base64_encode($values['goal_title']);?>' data-module="<?php echo (isset($exerciseRecord['setdetails'][$keys]) && count($exerciseRecord['setdetails'][$keys])>1 ? 'item_sets' : 'item_set');?>" id="itemSet_<?php echo $wkout_id.'_'.$exactOrder;?>"><!--wrkoutid.'_'.order.'_'.goal_unit_id-->
