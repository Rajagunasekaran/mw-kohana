<div id="wrap-index">
  ...
  <div class="container" id="home">
	...
	<ul class="sTreeBaseparent bgC4 col-xs-12 <?php if(isset($parentFolder) && empty($parentFolder)){ ?> hide <?php } ?>" style="border:1px solid #ededed;">
	...
	<ul class="sTreeBase bgC4 col-xs-12 scrollwkout" style="border:1px solid #ededed;<?php if(isset($parentFolder) && !empty($parentFolder)){ ?> margin-top:23px; <?php } ?>" >
			...
			<li class="bgC4 item_workout_noclick" data-id='itemworkout_<?php echo $values['wkout_id'].'_'.$values['wksid'].'_'.$order;?>' data-module="item_workout" id="itemworkout_<?php echo $values['wkout_id'].'_'.$values['wksid'].'_'.$order;?>">
				<div class="row item_workout_click" id="wkout_<?php echo $values['wkout_id'].'_'.$values['wksid'];?>">
					...
					<div class="border full">
						...
						<div class="row-pad">
							<div class="editchoosen col-xs-3">
