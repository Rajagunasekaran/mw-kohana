<div id="wrap-index">
	<div class="rest-nav-head">
		<div class="container">
			<?php $backurl = URL::base(TRUE).'exercise/exerciselibrary';
			if(isset($openfrom) && !empty($openfrom)){
				$backurl = ($openfrom == 'indx' ? URL::base(TRUE).'dashboard/index' : URL::base(TRUE).'exercise/exerciselibrary');
			} ?>
			<!-- xrwrapper -->
					...
					<div class="row xrwrappers-header-row">
						...
						<div class="page-head">
							<div class="col-xs-3 aligncenter">
								<a href="<?php echo $backurl; ?>" title="<?php echo __('Back'); ?>" class="triangle confirm" data-ajax="false" data-role="none" data-allow="<?php echo (Helper_Common::getAllowAllAccessByUser((Session::instance()->get('user_allow_page') ? Session::instance()->get('user_allow_page') : '1'), 'is_confirm_xr_create_hidden') ? 'false' : 'true'); ?>" data-notename="hide_confirm_xr_create" data-text="Clicking BACK or CANCEL will discard any changes. Clicking MORE will display record options such as SAVE. Continue with exiting?">
						...
						<form id="xrRecInsertForm" class="form-horizontal" method="post" action="" data-ajax="false" data-role="none">
							...
							<div class="tab-content-footer">
								<div class="tab-footer-btn">
									...
									<a href="<?php echo URL::base(TRUE).'dashboard/index'; ?>" title="<?php echo __('Cancel'); ?>" class="btn btn-default confirm" data-ajax="false" data-role="none" data-allow="<?php echo (Helper_Common::getAllowAllAccessByUser((Session::instance()->get('user_allow_page') ? Session::instance()->get('user_allow_page') : '1'), 'is_confirm_xr_create_hidden') ? 'false' : 'true'); ?>" data-notename="hide_confirm_xr_create" data-text="Clicking BACK or CANCEL will discard any changes. Clicking MORE will display record options such as SAVE. Continue with exiting?" style="margin-right: 20px;"><?php echo __('Cancel'); ?></a>
									<button type="button" class="btn btn-default submitTabsBtn activedatacol" data-toggle="modal" data-target="#xrcisesaveopt-modal" data-ajax="false" data-role="none"><?php echo __('more'); ?></button>
								</div>
							</div>
		...
		<div class="modal-dialog modal-md">
			<div class="modal-content">
				...
				<div class="modal-body opt-body">
					...
					<div class="opt-row-detail">
						<a href="javascript:void(0);" class="btn btn-default confirm" id="btn_revertdata" data-onclick="triggerXrFormReset();" data-allow="<?php echo (Helper_Common::getAllowAllAccessByUser((Session::instance()->get('user_allow_page') ? Session::instance()->get('user_allow_page') : '1'), 'is_confirm_xr_create_hidden') ? 'false' : 'true'); ?>" data-notename="hide_confirm_xr_create" data-text="This will discard any changes on this record. Do you want to SAVE or Continue with exiting?" style="width:100%" data-ajax="false" data-role="none">
							<div class="col-xs-12 pointer">
					...
					<div class="opt-row-detail">
						<a href="<?php echo URL::base(TRUE).'exercise/exerciserecord?act='.$openfrom; ?>" class="btn btn-default" id="btn_addrecord" style="width:100%" data-ajax="false" data-role="none">
							<div class="col-xs-12 pointer">
...
<div id="previewimg-modal" class="modal fade" role="dialog">
	<div class="vertical-alignment-helper">
...
<!-- img option modal -->
<div id="imageoption-modal" class="modal fade" role="dialog">
	<div class="vertical-alignment-helper">
		<div class="modal-dialog modal-md">
			<div class="modal-content">
				<div class="modal-header">
