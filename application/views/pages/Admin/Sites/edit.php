...
<!--link type="text/css" href="/assets/plugins/iCheck/flat/blue.css" rel="stylesheet" />
<script type="text/javascript" src="/assets/plugins/iCheck/icheck.js"></script-->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> <?php echo (isset($sites->name) ? $sites->name : 'Update Site');?>
                            </li>
                        </ol>
                    </div>
                </div>
                              ...
                              <div class="col-xs-9 activedeactivesite form-group">
								...
								<div class="row">
									<div class="col-lg-12">
										...
										<div class="col-xs-9 activedeactivesite form-group">
											<!--input type="number" class="form-control" value="<?php echo (isset($sites->min_agelimit) ? $sites->min_agelimit : '18');?>" name="min_agelimit" id="min_agelimit"-->
										
											<!--input type="number" class="form-control" value="18" name="min_agelimit" id="min_agelimit"/-->
											<?php
											$age = (isset($sites->min_agelimit)) ? $sites->min_agelimit : '18';
											$str ="
											<label class='range-square-radio'></label>
											<input  type='hidden' class=\"form-control \" id='min_agelimit' name='min_agelimit' value='18' readonly style='width:100%'><div id='agerange'></div>";
											$str .='
												<script>
												$( function() {
												  $( "#agerange" ).slider({
								...
								//if(Helper_Common::is_admin()){
										...
										<div class="row">
											<div class="col-lg-12">
												...
												<div class="col-xs-9 activedeactivesite form-group">
													<label><input type="radio" <?php echo (!isset($sites->common_question) || (isset($sites->common_question) && $sites->common_question=='1') ? 'checked=""' : '');?> value="1" name="common_question" <?php
										...
										if($v["status"]==0){
														...
														<div class="row">
															<div class="col-xs-12">
																...
																<div class="col-xs-9 activedeactivesite form-group">
																	<label>
																		<input type="radio" <?php echo ( isset($v["status_device"]) || (isset($v["status_device"]) && $v["status_device"]=='0') ? 'checked=""' : '');?>
																		  value="0" name="device[<?php echo $v["id"]; ?>]"> Active</label>
																	<label>
																		<input type="radio" <?php echo ((isset($v["status_device"]) && $v["status_device"]=='1') ? 'checked=""' : '');?>
