                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
							...
							if($session->get('current_site_name')!=''){echo '"'.$session->get('current_site_name').'"';}?> Update User
                        </h1>
                        <ol class="breadcrumb">
                            <li>
								...
								<div class="row">
									<div class="col-lg-12">
										<div class="form-group">
											...
											<label class="radio-inline">
												<input type="radio" value="1" id="beginner" <?php if( $userDetails['user_profile']==1) { echo 'checked'; } ?>  name="user_profile">Beginner
											</label>
											<label class="radio-inline">
												<input type="radio" value="2" id="non-beginner" <?php if( $userDetails['user_profile']==2) { echo 'checked'; } ?> name="user_profile">Non-Beginner
											</label>
										</div>
									</div>
								</div>
