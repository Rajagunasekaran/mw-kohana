	...
	<!--- Top nav && left nav --->
	  ...
	  <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            "<?php echo ucfirst($site_name); ?>" <?php echo (isset($site_language['Test Email'])) ? $site_language['Test Email'] : 'Test Email'; ?>
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i>  <?php echo (isset($site_language['Test Email'])) ? $site_language['Test Email'] : 'Test Email'; ?>
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
					 <div class="col-lg-6">
						<a class="btn btn-default" href="javascript:void(0);" onclick="showTestEmailForm();" style="margin-bottom:15px;"> <?php echo (isset($site_language['Add Test Email'])) ? $site_language['Add Test Email'] : 'Add Test Email'; ?></a>
					 </div>
				</div>
								...
								<div class="row">
									 <div class="col-lg-4">
										<div class="form-group">
											<label><?php echo (isset($site_language['Add Test Email'])) ? $site_language['Add Test Email'] : 'Add Test Email'; ?></label>
											<input type="text" class="form-control" value="" name="test_email">
										</div>
									 </div>
									 <div class="col-lg-2" style="margin:24px 0;">
										<button type="submit" name="add-email" class="btn btn-default"><?php echo (isset($site_language['Add Email'])) ? $site_language['Add Email'] : 'Add Email'; ?></button>
									 </div>
								</div>
							</div>
					...
					<div class="col-lg-12">
						<form role="form" method="post" action="">
							<div>
								<div class="row">
									<div class="col-lg-6">
										<div class="form-group select2contnr">
											<label><?php echo (isset($site_language['Test Email'])) ? $site_language['Test Email'] : 'Test Email'; ?></label>
									 ...
									 <div class="col-lg-6">
										<div class="form-group">
											...
											<?php if(isset($template_name_array) && count($template_name_array)>0) { ?>
												<select class="form-control selectAction" name="template_id">
													<option value=""><?php echo (isset($site_language['Select'])) ? $site_language['Select'] : 'Select'; ?></option>
								...
								<div class="row">
									<div class="col-lg-6">
										<button type="submit" name="send-email" class="btn btn-default"><?php echo (isset($site_language['Send Test Email'])) ? $site_language['Send Test Email'] : 'Send Test Email'; ?></button>
									</div>
								</div>
							</div>
						</form>
