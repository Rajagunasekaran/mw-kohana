...
<?php /*********************************************************/ ?>
<?php
$workoutModel     = Model::instance('Model/workouts');
  ...
  <div id="create-record"> 
	<div class="xrwrapper-div ">		
		<div class="row xrwrappers-header-row ">
			<div class="border popup-title">
				<div class="col-xs-3 aligncenter">
					<a href="<?php echo URL::base(TRUE).'admin/exercise/browse'; ?>" title="Back" class="triangle">
						<i class="fa fa-caret-left iconsize"></i>
					</a>
				</div>
				<div class="col-xs-6 aligncenter" id="dynXrTitle"><?php echo (isset($formtype) && $formtype=='edit')? 'Modify Exercise Record' : 'Create a New Exercise Record'; ?>
		...
		<hr>
		<div class="xrwrappers common-class" >
				...
				<div class="tab-content">
					...
					<div class="tab-pane active" id="file">
						...
						<hr>
						<?php }
						if(isset($exerciseAccess) && count($exerciseAccess)>0) { ?>
						<div class="form-group">
							<div class="col-xs-4"><label class="control-label">Access</label></div>
							<div class="col-xs-8">
								<div class="dropdown selectdropdownTwo">
									<select tabindex="2" class="" id="xru_access" name="xru_access">
										<option value="">Select an option</option>
										<?php foreach($exerciseAccess as $key => $value) { ?>
											
											<option value="<?php echo $value['id']; ?>"<?php if(isset($exerciseArray['access_id'])&&$exerciseArray['access_id']==$value['id']) echo "selected";?>><?php echo $value['name']; ?></option>
					...
					<div class="tab-pane" id="intro">
						...
						<div class="form-group img-div">
							...
							<div class="col-xs-5">
								<span class="img_thmb">
									<img alt="Feature Image" class="uploaded_image_thmb" id="intro_feature" src="<?php echo (isset($exerciseArray['img_url'])) ? URL::base().$exerciseArray['img_url'] : URL::base().'assets/images/icons/icon_grey-62.png';?>">
								</span>
							...
							<div class="col-xs-3 img-opt">
								<i class="fa fa-ellipsis-h iconsize trigger-imgopt bluecol" id="introclear" data-imgtagid="intro_feature" data-hidnimgid="xru_featImage" href="<?php echo URL::base().'assets/images/icons/icon_grey-62.png'; ?>"></i>
							</div>
						</div>
						<hr>
						<div class="form-group">
										...
										<li class="seq_order=<?php echo $si; ?> seq-panel">
											<div class="row subseq-title">
												<div class="col-xs-2 aligncenter">
													<span class="seq-move fa fa-bars bluecol"></span>
												</div>
												<div class="col-xs-8 aligncenter">	
													<span class="seq_title">Sequence <?php echo $si; ?></span>
												</div>
												<div class="col-xs-2 aligncenter">	
													<span class="seq_remove right remove_seq seq_btn fa fa-times bluecol" data-class="remove_seq"></span>
												</div>
											</div>
											<hr>
											<div class="seq_content">
												<div class="seq_img form-group form-group_seq img-div">
													...
													<div class="col-xs-5">
														<span class="img_thmb">
															<img alt="Feature Image" class="uploaded_image_thmb" id="seq-feature<?php echo $si; ?>" src="<?php echo (isset($seqvalues['img_url'])) ? '/'.$seqvalues['img_url'] : URL::base().'assets/images/icons/icon_grey-62.png'; ?>">
														</span>
													...
													<div class="col-xs-3"></div>
													<div class="col-xs-3 img-opt">
														<i class="fa fa-ellipsis-h iconsize trigger-imgopt bluecol" id="seqclear<?php echo $si; ?>" data-imgtagid="seq-feature<?php echo $si; ?>" data-hidnimgid="seq_img<?php echo $si; ?>" href="<?php echo URL::base().'assets/images/icons/icon_grey-62.png'; ?>"></i>
													</div>
												</div> <!-- /END .seq_img -->
												<hr>
												<div class="seq_desc form-group">
													<div class="col-xs-4">
														<label class="control-label" for="seqDesc<?php echo $si; ?>">
															<span>Sequence Description <img class="info-icon" src="<?php echo URL::base().'assets/images/icons/information.png'; ?>">
										...
										<li class="seq_order=1 seq-panel">
											...
											<div class="seq_content">
												<div class="seq_img form-group form-group_seq img-div">
													...
													<div class="col-xs-5">
														<span class="img_thmb">
															<img alt="Feature Image" class="uploaded_image_thmb" id="seq-feature1" src="<?php echo URL::base().'assets/images/icons/icon_grey-62.png'; ?>">
														</span>
														<input type="hidden" value="" id="seq_img1" name="seqImg[]" class="img_selected">
													</div>
													<div class="col-xs-3"></div>
													<div class="col-xs-3 img-opt">
														<i class="fa fa-ellipsis-h iconsize trigger-imgopt bluecol" id="seqclear1" data-imgtagid="seq-feature1" data-hidnimgid="seq_img1" href="<?php echo URL::base().'assets/images/icons/icon_grey-62.png'; ?>"></i>
													</div>
												</div> <!-- /END .seq_img -->
												<hr>
												<div class="seq_desc form-group">
					...
					<div class="tab-pane" id="data">
						...
						<?php } ?>
							<div class="form-group">
								<div class="col-xs-4 no-margin"><label class="control-label">Additional Equipments</label></div>
								<?php $XrciseEquipOth=array();
								
								if(isset($exerciseEquipOth) && count($exerciseEquipOth)>0){
									foreach ($exerciseEquipOth as $extactEquipoth) {
										foreach ($extactEquipoth as $key => $value) {
											if($key == 'equipoth_id'){
												$XrciseEquipOth[] = $value;
											}
										}
									}
								}
								if(isset($equip) && count($equip)>0) { ?>
								<div class="col-xs-8">
									<div class="equipothFrame left">
										<ul class="equipoth_chks col-sm-12">
											<?php foreach($equip as $key => $value){ ?>
												<li id="equip_id<?php echo $value['equip_id']?>" class="col-sm-6 equipoth_container">
													<div class="checkbox">
														<input type="checkbox" tabindex="4" value="<?php echo $value['equip_id']?>" class="equipoth_chkbx" id="equip_id-<?php echo $value['equip_id']?>" name="chkdEquipOth[]"<?php if(count($XrciseEquipOth) > 0 && in_array($value['equip_id'], $XrciseEquipOth)==true) echo "checked";?>/>
														<label for="equip_id-<?php echo $value['equip_id']?>"><?php echo $value['equip_title'];?></label>
														<div style="clear:left;"></div>
													</div>
												</li>
											<?php } ?>
				...
				<div id="xrcisesaveopt-modal" class="modal fade bs-example-modal-sm" role="dialog" data-keyboard="false" data-backdrop="static">
			...
			<div class="modal-header">
				<div class="row">
					<div class="popup-title">
						<div class="col-xs-2">
							<a href="javascript:void(0);" title="Back" class="triangle" data-dismiss="modal">
								<i class="fa fa-caret-left iconsize"></i>
							</a>
						</div>
						<div class="col-xs-8">Preview - Feature Image</div>
						<div class="col-xs-2"> </div>
					</div>
				</div>
			</div>
			...
			<div class="modal-header">
				<div class="mobpadding">
					<div class="border">
						...
						<div class="col-xs-8 optionpoptitle">Options for Image</div>
						<div class="col-xs-2"></div>
					</div>
				</div>
			</div>
				...
				<div class="opt-row-detail">
					<a href="javascript:void(0);" id="btn_imgpreview" class="btn btn-default img_mgr featimgprev" onclick="triggerImgPreviewModal('intro_feature');" style="width:100%">
						<div class="col-xs-12 pointer">
							...
							<div class="col-xs-9">Preview</div>
						</div>
					</a>
				</div>
				<div class="opt-row-detail">
					<a href="<?php echo URL::base().'assets/images/icons/icon_grey-62.png'; ?>" id="btn_imgclear" data-clearid="" class="btn btn-default img_mgr img_clear" style="width:100%">
						<div class="col-xs-12 pointer">
							<div class="col-xs-3"><i class="fa fa-refresh iconsize"></i></div>
							<div class="col-xs-9">Clear</div>
						</div>
					</a>
				</div>
			</div>
