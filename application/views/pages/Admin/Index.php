						  ...
						  <li class="slider-img" data-background="<?php echo URL::site('assets/uploads/manage/homepage/slider/'.$list['s_image']);?>">
								<div class="flick-content-box " style="border:<?php echo $list['content_border'];?>;background:<?php echo $list['content_bgcolor'];?>">
									 <div class="flick-title" style="color:#<?php echo $list['tile_color'];?> ">
										  <span class="flick-block-text" style="text-shadow:<?php echo $list['text_shadow'];?> "><?php echo __($list['s_title']);?></span>
									 </div>
						  ...
						  <li data-background="<?php echo URL::site('assets/img/slide/slide'.$ix.'.png');?>" style='border:none;'>
									 ...
									 <div  class="flick-content">
										  <div class="flick-title">
												<span   class="flick-block-text"><?php echo __('SLIDER IMAGE 1 TITLE'); ?></span>
										  </div>
	 ...
	 <?php if(isset($imgArray) && count($imgArray)>0) { ?>
		<div style="visibility:hidden;height:0" >
			<?php foreach($imgArray as $key => $value) { ?>
				<img class="sample-img" style="display:inline-block;width:100%" src="<?php echo $value;?>" />
			<?php } ?>
		</div>
	 <?php } ?>
            	...
            	<div class="container">
                	...
                	<div class="row-fluid span6 col-lg-6 video_section">
						...
						<div class="youtubevideo">
							 ...
							 <iframe src="<?php echo (isset($settinghome_url[0]['video']) ? $settinghome_url[0]['video'] : '');?>" width="380" height="180" frameborder="0" allowfullscreen></iframe>
							 <?php else:	 ?>
