	...
	<div class="modal-dialog modal-xs" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="exampleModalLabel">"<?php echo $current_site_name; ?>" Questions</h4>
			</div>
...
<div class="modal fade" id="questionoptionsModal" tabindex="-1" role="dialog" aria-labelledby="questionoptionsModal">
	...
	<div class="modal-dialog modal-xs" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<!--button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button-->
				<h4 class="modal-title" id="titleLabel">"<?php echo $current_site_name; ?>" Question Options</h4>
			</div>
			<div class="modal-body">
...
<input type='hidden' id='q_type' name='q_type' value='0'>