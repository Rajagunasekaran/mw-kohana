...
<div id="page-wrapper">
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">"<?php echo $current_site_name; ?>" Questions</h1>
				<ol class="breadcrumb">
...
<div class="row">
	<div class="col-lg-12">
		<h2 class="col-xs-6 col-sm-6 col-lg-6 no-margin-top questionlisttitle"><?php echo (isset($site_language['Site Questions List'])) ? $site_language['Site Questions List'] : 'Site Questions List'; ?></h2>
		<div class="col-xs-6 col-sm-6 col-lg-6 prev-quest">
			<div class="row">
				...
				<div class="col-xs-12 prev-quest-btn">
					...
					<a class="btn btn-default" href="javascript:void(0);" onclick='$("#questionsModal").modal("show");$("#sqid").val("");$("#questions").val("");$(".placeholder_text").val("");' style="float:right;">
...
<?php require_once(APPPATH.'views/pages/Admin/Questions/questions_modals.php');?>    
