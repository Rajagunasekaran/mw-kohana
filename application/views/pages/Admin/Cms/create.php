			...
			<div class="row">
				<div class="col-lg-12">
					 <form method="post" role="form" action="">
							...
							<a class="btn btn-default" href="<?php echo URL::base().'admin/cms/pagelist/'.$site_id;?>"><?php echo (isset($site_language['Page'])) ? $site_language['Page'] : 'Page'; ?> <?php echo (isset($site_language['List'])) ? $site_language['List'] : 'List'; ?></a>
