                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           "<?php echo ucfirst($site_name);?>" <?php echo (isset($site_language['Page'])) ? $site_language['Common Page'] : 'Common Page'; ?> <?php echo (isset($site_language['List'])) ? $site_language['List'] : 'List';
									//echo TEST_CONT;
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> <?php echo (isset($site_language['Page'])) ? $site_language['Common Page'] : 'Common Page'; ?> <?php echo (isset($site_language['List'])) ? $site_language['List'] : 'List'; ?>
                            </li>
                        </ol>
                    </div>
                </div>
			...
			<?php } ?>
                ...
                <div class="col-lg-12">
						...
						<?php if(Helper_Common::hasAccess('Create Pages')) { ?>
							<div class="col-xs-5 col-sm-5 col-lg-6"><a class="btn btn-default" href="<?php echo URL::base().'admin/cms/common_create/'.$site_id;?>" style="float:right;"><?php echo (isset($site_language['Add'])) ? $site_language['Add'] : 'Add'; ?> <?php echo (isset($site_language['Page'])) ? $site_language['Page'] : 'Page'; ?></a></div>
						<?php } ?>
								...
								<?php
									...
									<tr>
                                       ...
                                       <td><a target="_blank" href="<?php echo URL::base(true).'site/'.$value['slug']."/".$value['page_slug'];?>"><?php echo (isset($site_language['View'])) ? $site_language['View'] : 'View'; ?> <?php echo (isset($site_language['Page'])) ? $site_language['Page'] : 'Page'; ?></a></td>
										...
										<?php if(Helper_Common::hasAccess('Modify Pages')) { ?>
											<td>
												<select  class="form-control selectAction" onchange="commonpageAction(this.value,'<?php echo $value['page_id'];?>');">
