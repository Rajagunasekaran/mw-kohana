...
class Helper_Browser
{
    ...
    */
    ...
    {
        return "<div class='col-xs-12'><div class='col-xs-4'><strong>Browser Name:</strong></div><div class='col-xs-7'>{$this->getBrowser()}</div></div><br>" .
        "<div class='col-xs-12'><div class='col-xs-4'><strong>Browser Version:</strong></div><div class='col-xs-7'>{$this->getVersion()}</div></div><br>" .
        "<div class='col-xs-12'><div class='col-xs-4'><strong>Browser User Agent String:</strong></div><div class='col-xs-7'>{$this->getUserAgent()}</div></div><br>" .
        "<div class='col-xs-12'><div class='col-xs-4'><strong>Platform:</strong> </div><div class='col-xs-7'>{$this->getPlatform()}</div></div>";
    }
    /**
